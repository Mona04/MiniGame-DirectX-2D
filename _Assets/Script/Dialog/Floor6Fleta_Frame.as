	...
	void Update()
	{
		...
		if(_state == 0)
		{
			...
			case 2:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Fleta.png");
				dialogManager.DialogSetName("플레타");
				dialogManager.DialogSetText("플레타, 힘들었어.");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 4:
			{
				...
				dialogManager.DialogSetText("무슨일이 있었습니까?");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 6:
			{
				...
				dialogManager.DialogSetText("키홀이 플레타에게 이것저것 시켜댔어.\n키홀은 너무해. ");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 10:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Pepe.png");
				dialogManager.DialogSetName("당신");
				dialogManager.DialogSetText("아, 당신에게 마침 물어보고 싶은게 있습니다.");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 12:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Fleta.png");
				dialogManager.DialogSetName("플레타");
				dialogManager.DialogSetText("뭔데?");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 14:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Pepe.png");
				dialogManager.DialogSetName("당신");
				dialogManager.DialogSetText("당신은 블로니와 친구입니까?");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 18:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Pepe.png");
				dialogManager.DialogSetName("당신");
				dialogManager.DialogSetText("저기.. 그게...\n블로니가 착각을 하고 있는거 같아서..");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 20:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Fleta.png");
				dialogManager.DialogSetName("플레타");
				dialogManager.DialogSetText("알고있어.\n근데 그게 왜?");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 22:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Pepe.png");
				dialogManager.DialogSetName("당신");
				dialogManager.DialogSetText("아, 아무것도 아닙니다. \n알고있다니 뭐.. 괜찮겠죠.");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 24:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Fleta.png");
				dialogManager.DialogSetName("플레타");
				dialogManager.DialogSetText("밀레시안 주제아 남 걱정도 할 줄 아는구나?\n칭찬의 의미로 너에게 선물을 줄게.");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 26:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Fleta.png");
				dialogManager.DialogSetName("플레타");
				dialogManager.DialogSetText("팔다가 남은 로브들 너 줄게. \n고맙게 생각해.");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
