	...
	void Update()
	{
		...
		if(_state == 0)
		{
			...
			case 0:
			{
				...
				dialogManager.DialogSetText("13층입니다.\n시련은 받을만 하신가요?");
			...
			case 10:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/pepe.png");
				dialogManager.DialogSetName("당신");
				dialogManager.DialogSetText("모리안... 뭔지 모르겠지만 힘내세요?");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
		...
		switch(_cur)
			...
			case 2:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Morian.png");
				dialogManager.DialogSetName("모리안");
				dialogManager.DialogSetText("밀레시안.\n당신은 마차가 땅으로 꺼지고 하늘로 솟지 못하는 에린이라도 좋아할 수 있나요?");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 10:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/pepe.png");
				dialogManager.DialogSetName("당신");
				dialogManager.DialogSetText("다시한번 말슴드리자면, 그런 비현실적이고 웃기기만 하는 물리엔진이 고쳐진 에린은 천국입니다.!!");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
		...
		else if(_state == 2)
		{
			...
			case 1:
			{
				...
				{
					_cur += 1;
					inventoryManager.DeleteItemAuto("Herb_Blue", 50);
					inventoryManager.DeleteItemAuto("Herb_Dark", 50);
					inventoryManager.DeleteItemAuto("Herb_Red", 50);
					inventoryManager.DeleteItemAuto("Herb_Light", 50);
				}
				if(dialogManager.IsDialogButtonClicked(1))
				{
					_cur = 200;
