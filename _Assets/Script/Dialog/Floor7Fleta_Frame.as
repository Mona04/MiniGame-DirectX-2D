	...
	void Update()
	{
		...
		if(_state == 0)
		{
			...
			case 2:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Fleta.png");
				dialogManager.DialogSetName("플레타");
				dialogManager.DialogSetText("요즘은 고민거리가 있어.\n라브가 자꾸 목걸이를 물어뜯고\n혼자서 산책을 나가버리지 뭐야.");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 4:
			{
				...
				dialogManager.DialogSetText("라브의 안전이 걱정되겠군요.");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 6:
			{
				...
				dialogManager.DialogSetText("기껏 목걸이를 해줘도 금방 망가져버려서\n도저히 손을 못쓰겠어.\n나이도 먹을대로 먹은 애가 주책이야. ");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 8:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Pepe.png");
				dialogManager.DialogSetName("당신");
				dialogManager.DialogSetText("네에...");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 10:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Fleta.png");
				dialogManager.DialogSetName("플레타");
				dialogManager.DialogSetText("...그러고 보니 너.\n쓸만한 개목걸이 구해다 주지 않을래?\n너 정도라면 제법 능력도 있을 것 같으니까...");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 12:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Pepe.png");
				dialogManager.DialogSetName("당신");
				dialogManager.DialogSetText("어디서 구할 수 있습니까?");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 14:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Fleta.png");
				dialogManager.DialogSetName("플레타");
				dialogManager.DialogSetText("어디서 구해오냐고?\n그건 네가 알아봐야지.");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
		...
		else if(_state == 1)
		{
			...
			case 0:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Fleta.png");
				dialogManager.DialogSetName("플레타");
				dialogManager.DialogSetText("목걸이는 가져왔어?");
			...
			case 4:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Fleta.png");
				dialogManager.DialogSetName("플레타");
				dialogManager.DialogSetText("마누스에게 줄 티켓을 주고 싶긴한데, \n마누스가 없으니까 필요없겠다.");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
