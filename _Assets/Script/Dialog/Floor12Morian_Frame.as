	...
	void Update()
	{
		...
		if(_state == 0)
		{
			...
			case 0:
			{
				...
				dialogManager.DialogSetText("12층입니다.\n시련은 받을만 하신가요?");
			...
			case 2:
			{
				...
				dialogManager.DialogSetText("... 점점 몬스터가 쓰는 스킬이 괴랄해지기 시작했어요.");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 4:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Morian.png");
				dialogManager.DialogSetName("모리안");
				dialogManager.DialogSetText("당신도 그런 스킬을 사용하니까 괜찮은거 아닌가요?");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 6:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Morian.png");
				dialogManager.DialogSetName("모리안");
				dialogManager.DialogSetText("이런걸... 쌤쌤이라고 말하는 거겠죠?");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 8:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/morian.png");
				dialogManager.DialogSetName("모리안");
				dialogManager.DialogSetText("(모리안은 웃고 있다.)");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 10:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/pepe.png");
				dialogManager.DialogSetName("당신");
				dialogManager.DialogSetText("모리안... 당신은 여신이 맞는겁니까?");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 12:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/morian.png");
				dialogManager.DialogSetName("모리안");
				dialogManager.DialogSetText("그럼요. 저는 아름다운 여신님이랍니다.");
		...
		switch(_cur)
			...
			case 2:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Morian.png");
				dialogManager.DialogSetName("모리안");
				dialogManager.DialogSetText("밀레시안.\n당신은 사냥하다 텔레포트를 하지 못하는 에린이라도 좋아할 수 있나요?");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 10:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/pepe.png");
				dialogManager.DialogSetName("당신");
				dialogManager.DialogSetText("다시한번 말슴드리자면, 잡렉이 적고 위치렉도 없어서 쾌적하게 이동할 수 있다면 그곳은 천국입니다.!!");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 22:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/morian.png");
				dialogManager.DialogSetName("모리안");
				dialogManager.DialogSetText("각 약초를 50개씩 구해다주세요.\n그러면 그 에테르를 모아서 당신에게 드리겠습니다.");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
		...
		else if(_state == 2)
		{
			...
			{
				if(dialogManager.IsDialogButtonClicked(0) &&
					inventoryManager.GetItemStock("Herb_Blue") >= 50 && inventoryManager.GetItemStock("Herb_Red") >= 50 &&
					inventoryManager.GetItemStock("Herb_Dark") >= 50 &&  inventoryManager.GetItemStock("Herb_Light") >= 50 )
				{
					_cur += 1;
