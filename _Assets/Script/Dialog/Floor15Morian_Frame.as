	...
	void Update()
	{
		...
		if(_state == 0)
		{
			...
			case 0:
			{
				...
				dialogManager.DialogSetText("15층입니다. 앞으로 한층 남았어요.");
			...
			case 4:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Morian.png");
				dialogManager.DialogSetName("모리안");
				dialogManager.DialogSetText("뭐 이미 늦었겠지만요.");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
		...
		switch(_cur)
			...
			case 2:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/Morian.png");
				dialogManager.DialogSetName("모리안");
				dialogManager.DialogSetText("밀레시안.\n당신은 벽을 뚫고 지나갈수도 없고, 풀들을 위에서 봐도 이상하지 않은 에린이라도 좋아할 수 있나요?");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
			...
			case 10:
			{
				...
				dialogManager.DialogSetIllust("UI/NPC/pepe.png");
				dialogManager.DialogSetName("당신");
				dialogManager.DialogSetText("다시한번 말슴드리자면, 그래픽 개편이 된 에린은 천국입니다.!!");
				dialogManager.DialogSetButton(0, " 계속하기");
				_cur += 1;
				break;
			}
